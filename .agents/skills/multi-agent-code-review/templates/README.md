...
**導入先プロジェクトの `.agents/code-review/` ディレクトリ**から読む。
...
cp <このスキルのディレクトリ>/templates/architecture.md .agents/code-review/architecture.md
# 必要に応じて任意の設定もコピー
cp <このスキルのディレクトリ>/templates/solution.md .agents/code-review/solution.md
cp <このスキルのディレクトリ>/templates/maintainability.md .agents/code-review/maintainability.md
cp <このスキルのディレクトリ>/templates/testing.md .agents/code-review/testing.md
```
